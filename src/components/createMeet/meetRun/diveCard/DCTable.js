...
import JudgeScore from '../../../test/test-table/JudgeScore';
import DiveReturn from '../../../test/test-table/DiveReturn';
import JudgesScore from './JudgesScore';
...
const DCTable = ({
	...
	const judgeRow = [];
	for (let i = 0; i < 7; i++) {
		judgeRow.push(<JudgesScore key={i} i={i + 1} />);
	}
